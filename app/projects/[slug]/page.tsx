...
const projectsData: { [key: string]: any } = {
  'automated-maintenance-tracking': {
    ...
    shortDescription: 'Streamline maintenance requests with automated workflows, real-time notifications, and comprehensive tracking from submission to completion.',
    ...
    cover: 'https://static.wixstatic.com/media/0b340f_d146a1cff38b4503ae5e6ccc9aa86368~mv2_d_5184_3456_s_4_2.jpg/v1/fill/w_1920,h_492,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/0b340f_d146a1cff38b4503ae5e6ccc9aa86368~mv2_d_5184_3456_s_4_2.jpg',
    features: [
  ...
  'employee-attendance-system': {
    ...
    shortDescription: 'Advanced biometric and digital attendance tracking with automated timesheet generation, leave management, and payroll integration.',
    longDescription: 'Transform your HR operations with our comprehensive employee attendance system. Support multiple check-in methods including biometric scanners, mobile apps, and web-based clock-in. Automated timesheet generation eliminates manual data entry while integrated leave management streamlines approval workflows. The system seamlessly connects with payroll processing, ensuring accurate salary calculations based on actual attendance, overtime, and leave records.',
    cover: 'https://static.wixstatic.com/media/0b340f_c407b331d71449afa40b30f6efb200aa~mv2_d_5580_4160_s_4_2.jpg/v1/fill/w_1920,h_492,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/0b340f_c407b331d71449afa40b30f6efb200aa~mv2_d_5580_4160_s_4_2.jpg',
    features: [
  ...
  'smart-invoicing-payments': {
    ...
    shortDescription: 'Automated invoice generation, multi-payment gateway integration, and real-time payment tracking with detailed financial reporting.',
    ...
    cover: 'https://static.wixstatic.com/media/0b340f_0b4d1813105145bfa782ce1d7a379151~mv2_d_5760_3840_s_4_2.jpg/v1/fill/w_1920,h_492,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/0b340f_0b4d1813105145bfa782ce1d7a379151~mv2_d_5760_3840_s_4_2.jpg',
    features: [
  ...
  'tenant-portal-app': {
    ...
    shortDescription: 'Give tenants 24/7 access to rent payments, maintenance requests, documents, and announcements through web and mobile platforms.',
    ...
    cover: 'https://static.wixstatic.com/media/0b340f_a075ec7cf76b4b479b4b482e44a88c43~mv2_d_3840_5760_s_4_2.jpg/v1/fill/w_1920,h_492,al_tr,q_80,usm_0.66_1.00_0.01,enc_auto/0b340f_a075ec7cf76b4b479b4b482e44a88c43~mv2_d_3840_5760_s_4_2.jpg',
    features: [
      'Online rent payment',
  ...
  'property-sales-crm': {
    ...
    shortDescription: 'Complete CRM solution for managing property listings, leads, client communications, and sales pipeline with automated follow-ups.',
  ...
  'analytics-reporting-dashboard': {
    ...
    category: 'Analytics',
    shortDescription: 'Comprehensive analytics dashboard with customizable reports, KPI tracking, and predictive insights for data-driven decision making.',
  ...
  if (!project) {
    return (
      <div className="max-w-7xl mx-auto px-8 py-20 text-center">
        ...
        <p className="text-gray-600 mb-8">The requested feature could not be found.</p>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto mt-[-120px] relative bg-white px-8 sm:px-20">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {project.features.map((feature: string, index: number) => (
              <div key={index} className="flex items-start gap-3 p-4 border-l-4 border-blue-site bg-gray-50">
                <svg className="w-5 h-5 text-purple-site mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {project.benefits.map((benefit: string, index: number) => (
              <div key={index} className="flex items-center gap-3 p-6 bg-blue-site text-white rounded">
        ...
        {project.gallery && project.gallery.length > 0 && (
          <div className="mt-16">
            <h2 className="text-3xl font-site text-center mb-8">Screenshots & Preview</h2>
